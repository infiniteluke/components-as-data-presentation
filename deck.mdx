...
<Iframe
  fallback={<img style={{ height: '100%' }} src="./images/nbcdotcomhomepage.gif" />}
  src="https://nbc.com"
  title="NBC.com"
>
</Iframe>
...
<Iframe
  fallback={<img style={{ height: '100%' }} src="./images/graphql-componentsasdata.gif" />}
...
<Iframe 
  fallback={<img style={{ height: '100%' }} src="./images/voyager-componentsasdata.gif" />}
