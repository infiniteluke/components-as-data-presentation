...
<iframe 
  src="https://componentsasdata.lukeherrington.com/.netlify/functions/voyager"
  style={{
    padding: '2%',
    width: '100%',
    height: '100%'
...
```jsx 3:17 subtitle="Slideshow has state and data from the API"
...
```jsx 9:14 subtitle="It generically renders its children"
import React from 'react';
...
```jsx 58:68 subtitle="These dictionaries match our GraphQL interfaces"
import React from 'react';
...
```jsx 69:80 subtitle="Generically render a component from the API"
import React from 'react';
...
```jsx 81:99 subtitle="Match slots with interface dictionaries and render"
import React from 'react';
